...
| Doc | Purpose |
| --- | --- |
| [01 — Competitive research](./01-competitive-research.md) | Market patterns |
| [02 — Product & tech plan](./02-complete-product-tech-plan.md) | Original catalogue plan |
| [03 — ERP suite](./03-erp-suite.md) | Staff/owner ERP vision |
| [04 — Supabase setup](./04-supabase-setup.md) | Project connection |
| [05 — Developer guide](./05-developer-guide.md) | Local setup |
| [06 — ERP module map](./06-erp-module-map.md) | Routes ↔ tables |
| [07 — Implemented vs planned](./07-implemented-vs-planned.md) | Live status matrix |
